...
export class SocialSigninComponent implements OnInit {
  ...
  setUserInStorage(res) {
    if (res.user) {
      localStorage.setItem('adminTalabat', JSON.stringify(res.user));
      const loggedInUser = JSON.parse(localStorage.getItem('adminTalabat'));
      this.user = {
      ...
      localStorage.setItem('adminTalabat', JSON.stringify(res));
    }
  }
}
