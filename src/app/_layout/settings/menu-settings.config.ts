...
export const MenuSettingsConfig: MenuConfig = {
  ...
  vertical_menu: 
    localStorage.getItem("selected").split('"').join('') === "en" ? {
    items: [
      {
      ...
      },
     {
      ...
      },
      {
        ...
        submenu: {
          items: [
            ...
            // {
            //   title : 'Meal Category Requests List' ,
            //   page :  '/requests/mealCategory'
            // }
          ]
        }
      },
      {
        ...
        submenu: {
          items: [
            {
              title: 'Resturant ',
              page: '/requests/resturants'
            },
            {
              title: 'Resturant Category ',
              page: '/requests/categories'
            },
            {
              title : 'Meal Category ' ,
              page :  '/requests/mealCategory'
            ...
            {
              title : 'Meal Sub Category ' ,
              page :  '/requests/mealSubCategory'
            },
            {
              title : 'Meal ' ,
              page :  '/requests/meal'
      ...
      },
      {
        ...
        submenu: {
          items: [
            {
              title: 'Resturant Categories',
              page: '/resturantCategory/list'
            },
            {
              title: 'Sweet Categories',
              page: '/mealCategories/list'
            },
            {
              title: 'Sweet Sub Categories',
              page: '/mealSubCategories/list'
            },
          ]
        }
      },
      {
        title: 'Countries Manangement',
        icon: 'la-home',
        page: 'null',
    ...
    items: [
      ...
      },
      {
        ...
        submenu: {
          items: [
            ...
            {
              title: ' طلبات تصنيفات المطاعم',
              page: '/requests/categories'
            },
            {
              title : ' طلبات تصنيفات الوجبات' ,
              page :  '/requests/mealCategory'
            },
            {
              title : 'طلبات الوجبات' ,
      ...
      },
      {
        ...
        submenu: {
          items: [
            ...
            {
              title: 'تصنيفات الحلويات ',
              page: '/mealCategories/list'
            },
            {
              title: 'التصنيفات الفرعية للحلويات',
              page: '/mealSubCategories/list'
            },
          ]
        }
      ...
      },
      {
        ...
        submenu: {
          items: [
            {
              title: 'ارسال اشعارات للمستخدمين',
              page: '/notification/list'
            },
            {
              title: 'عرض الاشعارات',
