...
export class EditComponent implements OnInit , OnDestroy{
  ...
  constructor(private formBuilder: FormBuilder,private service: Constant , 
    ...
    getManagerById(){
      ...
      this.service.getManagerById(this.param_id).then(
        (res : Manager)=> {
          this.info = res ;
          console.log(res);
          ...
          this.editForm = this.formBuilder.group({
            ...
            role_id : [this.info.roles[0].id, Validators.required ] ,
            photo : [],
  ...
  submit()
  {
    ...
    console.log(newItem)
    this.service.updateManager( this.param_id , newItem).then(
      res=> {
      this.loaderBtn = false;
      photo = null;
     this.toastr.success(this.translate.instant('msg.editManager'));
      setTimeout(() => 
        {
  ...
  ngOnInit() {
    ...
    this.breadcrumbAr = {
      'mainlabel': 'تعديل معلومات المستخدم',
      'links': [
        {
